...
sigma <- matrix(c(1, 0.8,
                  0.8, 1), 2, 2)  # Covariance matrix
# In this AI-assisted version, I changed both the 0,5 into 0,8, so the correlation is turning into 0,8.
print(sigma) # We can see that the correlation is now 0.8
...
ggplot(df, aes(x = X, y = Y)) +
  ...
  stat_density_2d(color = "blue") +   # This is the contour lines, suggested by ChatGPT
  theme_minimal() +
